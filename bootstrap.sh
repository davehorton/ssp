...
check_lt_ver() {
  ...
  libtool=${LIBTOOL:-`${BASEDIR}/deps/sofia-sip-1.12.11/PrintPath glibtool libtool libtool22 libtool15 libtool14`}
  libtool=${LIBTOOL:-`${BASEDIR}/deps/sofia-sip-1.12.11/PrintPath glibtool libtool libtool22 libtool15 libtool14`}
  ...
  if test $lt_status = "good"; then
    ...
    echo "           You need libtool version 1.5.14 or newer to build ssp from source."
    exit 1
  fi
}
...
check_libtoolize() {
  ...
  if [ -n "${LIBTOOL}" ]; then
    ...
    libtoolize=${LIBTOOLIZE:-`${BASEDIR}/deps/sofia-sip-1.12.11/PrintPath glibtoolize libtoolize libtoolize22 libtoolize15 libtoolize14`}
  fi
